...
% \usepackage[backend=biber,style=authoryear,natbib=true]{biblatex} % Use the bibtex
\usepackage[backend=biber,style=apa, citestyle=apa,natbib=true, sorting=anyt]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
...
\newacronym{idmp}{IDMP}{Integrated Drought Managment Programme}
\newacronym{iwmi}{IWMI}{International Water Management Institute}
\newacronym{wpi}{WPI}{Water Poverty Index\autocite{harrowsmithFutureForecastImpact2020,svobodaHandbookDroughtIndicators2016,vereintenationenSpecialReportDrought2021}}
\newacronym{}{}{}
...
% \noindent\enquote{\itshape Speed test Thanks to my solid academic training, today I can write hundreds of words on virtually any topic without possessing a shred of information, which is how I got a good job in journalism.}\bigbreak
