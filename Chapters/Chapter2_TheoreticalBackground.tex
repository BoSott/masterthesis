...
% take this subsection out of it -> should world well as intro to the chapter. 
\subsection{FbF and paradigm shift}

traditionally + still common and important

but: gap between 

also financially -> but changing
...
The IFRC together with the Red Cross Climate Center \textit{(RCCC)} and German Red Cross \textit{(GRC)} have developed and improved the FbF programme to fund EAs since 2007 \autocite{ifrcForecastbasedFinancingNew2019}. Following \autocite{coughlandeperezForecastbasedFinancingApproach2015, coughlandeperezActionbasedFloodForecasting2016} the structure of FbF can be distilled down to:
...
Thus, the FbF approach involves three main components (1) triggering (2) pre-defined EAs and securing a (3) financing mechanism in advance (TODO: “Forecast-based Financing A new era for the humanitarian system” ([pdf](zotero://open-pdf/groups/4773535/items/KQZXSWVN?page=1&annotation=3BW2ZYST))). These components are summarized in an Early Action Protocol \textit{(EAP)}
