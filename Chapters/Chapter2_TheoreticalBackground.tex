...
\subsection{Forecasts and Trigger} % melt these two together
...
There are commonly two ways to define a trigger for early actions. On one side, triggers can be consensus-based, meaning experts make  real-time judgements by synthesizing information from multiple sources, or on the other side, triggers are data-driven, peer-reviewed and validated well in advance of a potential event \autocite{rcrcFORECASTBASEDFINANCINGEARLY2020}. Drought with its different layers of complexity may also benefit from a combination of these mechanisms, as e.g. the framework of \autocite{boultDroughtImpactbasedForecasting2022} proposed above shows. Generally, good conditions for effective triggers are sufficient historical data, knowledge about local livelihoods and how diverse parts of communities are influenced differently, thorough identification of differentiated impact drivers and their correlation to magnitudes as well as trustworthy forecasts \autocite{coughlandeperezForecastbasedFinancingApproach2015,coughlandeperezActionbasedFloodForecasting2016,elisabethstephensFORECASTBASEDACTION2015,harrowsmithFutureForecastImpact2020,rcrcFORECASTBASEDFINANCINGEARLY2020}. 

%drought definition framing also important for trigger setting
“the importance of framing the definition and indicators that we will be focusing on is paramount.” ([RCRC, 2020, p. 27](zotero://select/groups/4773535/items/UESIQTRJ)) ([pdf](zotero://open-pdf/groups/4773535/items/P5JPVZ97?page=27&annotation=WXGDLXZJ))
“Then we can identify empirical thresholds at which drought becomes a humanitarian concern - this will be highly context specific” ([RCRC, 2020, p. 27](zotero://select/groups/4773535/items/UESIQTRJ)) ([pdf](zotero://open-pdf/groups/4773535/items/P5JPVZ97?page=27&annotation=SIET7L9B))
...
In contrast to other hazards like flood and heavy rains, defining a trigger for drought as a slow-onset hazard  

% e.g. flood:
“The standard hydrological definition is when a river goes out-of-bank” ([Elisabeth Stephens et al., 2015, p. 10](zotero://select/groups/4773535/items/B2NYQLGZ)) ([pdf](zotero://open-pdf/groups/4773535/items/WKFPUZCW?page=14&annotation=WLB4VQSP))
“, however, from a human perspective a flood can be defined more broadly as when water temporarily inundates the land causing a negative impact.” ([Elisabeth Stephens et al., 2015, p. 10](zotero://select/groups/4773535/items/B2NYQLGZ)) ([pdf](zotero://open-pdf/groups/4773535/items/WKFPUZCW?page=14&annotation=Z8REJHXS))
% here impact is still relevant but easier to measure -> does the water reach houses or so? -> impact


% drought specifics
not as urgent, but more uncertainty, less granularity and lower accuracy (RCRC 2020)
-> timing of no precipitation also matters -> dependent on the crop season (RCRC 2020), e.g. no rain at the beginning of the planting season --> especially devastating
-> not only when but also where !!
...
--> drought --> multiple triggers /staggered triggers

“Figure 5. Contrasting the timeline between fast-onset hazards and droughts” ([RCRC, 2020, p. 20](zotero://select/groups/4773535/items/UESIQTRJ)) ([pdf](zotero://open-pdf/groups/4773535/items/P5JPVZ97?page=20&annotation=Q4LRCBC4))

also in terms of magnitude (of the action taken -> slow up to e.g. cash transfers before peak impact)
...
“Indeed, certain regions (and seasons) may have greater current potential for a functional triggering system that is largely based on a seasonal weather forecast” ([RCRC, 2020, p. 31](zotero://select/groups/4773535/items/UESIQTRJ)) ([pdf](zotero://open-pdf/groups/4773535/items/P5JPVZ97?page=31&annotation=BZ7QUEVQ))
...
% ------------------------> acting in vain + transition to drought specifics <------------------------

--> hightend risk of false alarms / acting in vain (which can erode trust) --> clear understanding of tipping points is fundamental
...
--> this work -> on the ground indicators/impacts -> low risk for false alarms (here??)

% ------------------------> Drought specifics <------------------------
-> for acting in vain -> get's even worse / tacktiks against it... and so on
-> could be lessen with knowledge from the ground / local context / local knowledge
...
all of this can be enhanced by local or indigeneous knowledge and data from the ground 
...
% local knowledge --> same as with indicators, forecasting is also possible on the basis of local knowledge
...
%%%%%%%%%%%%%%%%%%%%%%%%%% look for the right spellchecker --> thinkpad thing
