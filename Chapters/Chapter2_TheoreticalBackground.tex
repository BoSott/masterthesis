...
strengths and weaknesses of each + benefits (!!) important (!!) (also for the participants)

limitations -> costs, quality/accuracy --> e.g. VGI data (here??), training, etc.



outlook -> or better participatory monitoring?
% next chapter:
crowdsourcing/sensing (definition, strength, weaknesses, how it compares to others )


transition to phooooooooooooones and their applicability for this context -> mention the upcoming chapter about the tools

o Crowdsensing etc. - possibly that it is just not possible to implement these actions with the existing forecasts and triggers and thus shit has to happen somewhere somehow by someone.
...
% -------------------------------------------------------------------------------------------
\subsubsection{Motivation of Volunteers} % possibly only include this as a paragraph in the above chapter.. it's not that important in this context as the participants are already motivated volunteers.
