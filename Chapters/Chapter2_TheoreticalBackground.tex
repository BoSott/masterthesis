...
% order of the sub-chapter
just measurement (water flow, water height or what ever)

-> + risk based indices 

definition of risk (e.g. from the Special report on drought)

--> impact stuff indices and indicators


indices based on single indicators

indices for a 'single topic'

examples of indices for water security, water scarcity, drought and short outlook on what ever else. 


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% !!!! KEEP IT CONCISE IF NOT EVEN SHORT !!! reasoning is more important than detailed lists of indicators and their pros and cons --> name the main and let it be okay. F**k perfectionism. Can always add stuff later if wanted (which will never be the case, tbh)
...
Determining the right set of indicators and indices to e.g. assess hazard severity depends on the objective and available data and is often a balancing act between many factors and circumstances \autocite{svobodaHandbookDroughtIndicators2016}. Besides the pure description of what certain natural or social circumstances \textit{are}, there is an growing interest to understand what these conditions will \textit{do} \autocite{boultDroughtImpactbasedForecasting2022}.

to understand the effects on site, one needs to understand local conditions and their risk status --> definition of risk


Risk based 

based on the knowledge of the likely severity of the weather development and the individual and spatially restricted risk factors one can access the impact of a certain weather phenomenon or climate development on the situation on site. These information can then facilitate exact and presice assessments of the conditions and help to react accordingly (policy, management, etc. ) 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Transition to risk:
“risk based water security indicators” ([Mishra et al., 2021, p. 8](zotero://select/groups/4773535/items/MD2Z2HTF)) ([pdf](zotero://open-pdf/groups/4773535/items/366Z36U7?page=8&annotation=FRGCTJ8V))
“The risk analysis explores the range of likely future situations ranging from business as usual to extremely unlikely conditions [30]” ([Mishra et al., 2021, p. 8](zotero://select/groups/4773535/items/MD2Z2HTF)) ([pdf](zotero://open-pdf/groups/4773535/items/366Z36U7?page=8&annotation=LF2BSN3K))
...
“The interaction of the hazard event and the exposed elements (people, agricultural areas, reservoirs and water supplies), and the vulnerabilities of these elements to droughts, determines the impacts.” ([Svoboda et al., 2016, p. 11](zotero://select/groups/4773535/items/MMM69Q42)) ([pdf](zotero://open-pdf/groups/4773535/items/E2YACAV3?page=11&annotation=BEA45P8D))
...
Inability to fully capture the complexity of drought impacts: Drought impacts often involve complex and dynamic interactions between hazards, vulnerabilities, and exposures, and may be exacerbated by non-climate factors such as conflict or economic conditions. It can be difficult to fully capture and understand these interactions in IbF systems. (ChatGPT)
...
% aaaaaaaaand gender. Nope. max two sentences.
...
%%% water security strongly linked to water scarcity
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
“Framing the challenges of water security goes beyond single-issue indicators such as water stress.” ([Mishra et al., 2021, p. 3](zotero://select/groups/4773535/items/MD2Z2HTF)) ([pdf](zotero://open-pdf/groups/4773535/items/366Z36U7?page=3&annotation=7TEIK97J))
“it is crucial to shift from ad hoc and isolated water solutions to integrated water resources management approaches, which yield more sustainable and resilient systems.” ([Mishra et al., 2021, p. 4](zotero://select/groups/4773535/items/MD2Z2HTF)) ([pdf](zotero://open-pdf/groups/4773535/items/366Z36U7?page=4&annotation=GZY2PWBZ))
...
(liu et al 2017 “2. An Overview of Classical Water Scarcity Indicators” ([Liu et al., 2017, p. 547](zotero://select/groups/4773535/items/6LCA67BF)) ([pdf](zotero://open-pdf/groups/4773535/items/XDWCZPNG?page=3&annotation=WL4MAS84)))
“water stress indicator or Falkenmark indicator,” ([Mishra et al., 2021, p. 7](zotero://select/groups/4773535/items/MD2Z2HTF)) ([pdf](zotero://open-pdf/groups/4773535/items/366Z36U7?page=7&annotation=D46GSIGA))

“water resources vulnerability index,” ([Mishra et al., 2021, p. 7](zotero://select/groups/4773535/items/MD2Z2HTF)) ([pdf](zotero://open-pdf/groups/4773535/items/366Z36U7?page=7&annotation=WUWGQEXU))

“economic water scarcity index” ([Mishra et al., 2021, p. 7](zotero://select/groups/4773535/items/MD2Z2HTF)) ([pdf](zotero://open-pdf/groups/4773535/items/366Z36U7?page=7&annotation=2AUH3G5G))

“water poverty index,” ([Mishra et al., 2021, p. 7](zotero://select/groups/4773535/items/MD2Z2HTF)) ([pdf](zotero://open-pdf/groups/4773535/items/366Z36U7?page=7&annotation=CC9L4GB7))

%water scarcity monitoring and indices
...
"Indicators and indices are both used to measure and track various aspects of social, economic, or environmental phenomena, but they differ in their level of complexity and aggregation.

Indicators are individual measures that provide information about a specific aspect of a larger phenomenon. For example, GDP per capita is an indicator of economic development, while infant mortality rate is an indicator of population health. Indicators are often used to track progress towards a specific goal or target, and can be aggregated to provide a more comprehensive view of a particular phenomenon.

Indices, on the other hand, are composite measures that combine multiple indicators into a single score or ranking. Indices are often used to compare countries or regions, or to track changes over time in a specific area. Examples of indices include the Human Development Index (HDI), which combines indicators of income, education, and health to provide a measure of overall human development, and the Environmental Performance Index (EPI), which combines indicators of environmental health and ecosystem vitality to rank countries' environmental performance.

In summary, indicators are individual measures that provide information about a specific aspect of a larger phenomenon, while indices are composite measures that combine multiple indicators into a single score or ranking to provide a more comprehensive view of a particular phenomenon." ChatGPT


% drought
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%good overview. slide 17 https://www.pr-ccc.org/download/2NWS_Odalys.pdf
focus on: SPEI, SPI, and EDDI
...
https://www.drought.gov/sites/default/files/2020-06/GWP_Handbook_of_Drought_Indicators_and_Indices_2016.pdf
+ more e.g. food, health, agricultural, market prices etc. (e.g. Gualazzini 2021)
...
--> focus on over 50 drought indices



“indicators on livelihood, market prices, health, population movement and coping capacities to monitor the compound effects of multiple shocks.” ([Gualazzini, 2021, p. 8](zotero://select/groups/4773535/items/BWDYDL8T)) ([pdf](zotero://open-pdf/groups/4773535/items/8U5XVU5K?page=8&annotation=BWUT24HF))
...
%standard food security indicators, including the average household dietary index and the food consumption score,
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
sooo... indices and impact as well as risk have been established as concepts.

short intro to risk assessment 
intro general EAP
+ going over to specialities of a drought EAP

--> Somalia so far. But: still under development.

nonetheless, the concept of triggers and actions will be presented
but: focus on Somali EAP and their foci

financing can be neglected as it is not the topic of this work. but mention at least DREF shortly
...
selecting early actions
develop EAP
validate
continue monitoring until shit happens
-> Early Actions

\missingfigure[options]{“Figure 2 - EAP Validation Steps” ([RCRC, 2020, p. 4](zotero://select/groups/4773535/items/UESIQTRJ)) ([pdf](zotero://open-pdf/groups/4773535/items/P5JPVZ97?page=4&annotation=6WWVYXLT))}



(1) triggering (2) pre-defined EAs and securing a (3) financing mechanism in advance
+ drought specifics

% ----------> financing is not of great interest here.. different story and: <-----------
The International Federation of Red Cross and Red Crescent Societies \textit{(IFRC)} has extended their Disaster Relief Emergency Fund \textit{(DREF)} with Forecast-based Action as dedicated mechanism to adequately support their increased numbers of FbF projects TODO: cite item K89MIG2V.
summery of trigger selection of actions and financing mechanism.




% nice overview for the validation of an EAP graphic..
% myself UGGD:
The concretisation of the trigger, the selection of affected regions and selected actions
is essentially based on two conducted analyses: the forecast and the risk assessment.
Based on historic data, experiences and the risk assessment, specific impact thresholds
have been defined as triggers for the EAP and therefore define if and when the EAP
is activated. That is, when a certain level of damage in a certain minimum number of
regions is predicted by the forecast, the EAP is activated (FbF).

The risk assessment is a complex analysis that takes numerous factors on different scales into account. The quality and complexity of this analysis may differ from programme
to programme since it is strongly dependent on the availability of data and local
knowledge as well as analysis capacities. Potential data sources may be existing unofficial
or official datasets or it may be necessary to generate new data through quantitative
or qualitative surveys. Data quality can also be a concern that needs to be addressed.
Possible inputs are for example records of historical events and their specific impacts, location
of housing and thus their exposure to e.g. flood, and building structures together
with their resilience to the respective hazard. Social variables such as income and demographics
are also considered in the analysis. The goal of this evaluation is to highlight
the most effective actions and define recipients of the given resources as objectively as
possible.

The financing mechanism automatically allocates resources when the forecast-based
trigger is reached and the EAP activated. The Forecast-based Action (FbA) fund as part of
the Disaster Relief Emergency Fund (DREF) is managed by the IFRC and contributed by
private and public donors with the goal to dedicate a funding mechanism to release funds
before a disaster strikes (IFRC). This core concept is what makes the implementation of
Early Actions possible in the first place (IFRC & GRC, 2019).

EAP:
In the Early Action Protocol, the specific triggers, selection of actions, financing mechanisms
and responsibilities are explicitly defined, summarised and clearly assigned to the
actors involved. Resulting in clear responsibilities and the full commitment of all stakeholders
in the event of activation. This shall essentially help to implement the predefined
actions efficiently and in time (FbF).

+ Partners GRC, IFRC, RCCC, etc. (if wanted)





“The EAPs serve as action guidelines that delineate roles and responsibilities for quick action when a trigger is reached. The EAPs are agreed by a technical committee that includes scientists, humanitarian actors and local authorities and a clear commitment of implementation established among the involved parties.” ([“Forecast-based financing: A policy overview”, p. 2](zotero://select/groups/4773535/items/35XBEGJ7)) ([pdf](zotero://open-pdf/groups/4773535/items/8YZAQB5L?page=2&annotation=B28FW4AK))

include the specifics for a specfic region as well

+ Fund of the IFRC itself -> DREF (Disaster Relief Emergency Fund) https://www.forecast-based-financing.org/fund/
“Forecast-based Action by the DREF” ([pdf](zotero://open-pdf/groups/4773535/items/K89MIG2V?page=1&annotation=ER8SP944))
...
“The structure of such a forecast-based financing system has evolved through the development of the pilot studies and can be distilled from Coughlan de Perez et al. (2015b) as follows: “When forecast states that an agreed-upon probability threshold is exceeded for a hazardof a designated magnitude, then an action with an associated costmust be taken that has a desired effectand is carried out by a designated organisation.”” ([pdf](zotero://open-pdf/groups/4773535/items/WKFPUZCW?page=6&annotation=VLZGESVE))
...
%acting in vain etc: --> related costs
“able 2: Illustration of possible outcomes of forecast-based action, adapted from Suarez and Tall (2010)” ([pdf](zotero://open-pdf/groups/4773535/items/WKFPUZCW?page=19&annotation=7E2VEPQT))
